...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerName = PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAME_MULTIPLAYER, "Player" + UnityEngine.Random.Range(0, 1000f).ToString());
    ...
    private void NetworkManager_OnClientConnectedCallback(ulong clientId)
    {
        ...
        SetPlayerIdServerRpc(KitchenGameLobby.Instance.GetPlayerId());
    }
    ...
    {
        //check whether playerIndex is within valid range of playerDataNetworkList
